...
class RPPG(QObject):
    ...
    def __init__(self, roi_detector, parent=None, camera=None,
                 hr_calculator=None, resp_calculator=None):
        ...
        self.resp_calculator = resp_calculator
        if self.resp_calculator is not None:
            self.new_respr = self.resp_calculator.new_respr
        else:
            self.new_respr = self._dummy_signal
